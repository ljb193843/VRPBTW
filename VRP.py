...
cities = {0:'Almeria',1:'Cadiz',2:'Cordoba',3:'Granada',4:'Huelva',5:'Jaen',6:'Malaga',7:'Sevilla',8:'quilicura'}

#Distance between each pair of cities

w0 = [999,454,317,165,528,222,223,410,323]
w1 = [453,999,253,291,210,325,234,121,323]
w2 = [317,252,999,202,226,108,158,140,323]
w3 = [165,292,201,999,344,94,124,248,323]
w4 = [508,210,235,346,999,336,303,94,323]
w5 = [222,325,116,93,340,999,182,247,222]
w6 = [223,235,158,125,302,185,999,206,222]
w7 = [410,121,141,248,93,242,199,999,111]
w8 = [410,121,141,248,93,242,199,999,111]
...
if __name__ == "__main__":
    ...
    print ("numero de camiones",num_trucks)
